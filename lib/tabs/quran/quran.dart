        ...
        Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
              Text('عدد الآيات',style: Theme.of(context).textTheme.headlineSmall,),
              ...
              child: ListView.separated(itemBuilder: (context, index) =>
                  InkWell(
                    onTap: (){
                      ...
                      arguments: suraArgs(index, suraNames[index]));
                    },
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        ayat_of_suraName[index],
